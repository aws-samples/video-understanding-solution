...
then
    ...
    cd .. && sudo rm ./Python-3.9.18.tgz && sudo rm -rf ./Python-3.9.18 && cd ..
    cd .. && rm -rf ./packages
fi
...
npm install -g aws-cdk@">=2.173.1"
npm install -g @aws-cdk/aws-amplify-alpha@">=2.173.1-alpha.0"

python3 -m pip install --upgrade pip
python3 -m pip install --upgrade "aws-cdk-lib>=2.173.1"
